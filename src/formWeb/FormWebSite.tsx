...
function ContactWebForm() {
  ...
  return (
    ...
    <input
      ...
      name="phone"
      className="w-full px-4 py-2 rounded-lg border-gray-300 focus:outline-none focus:ring focus:ring-blue-200"
      placeholder="Escriba su numero de telefono por favor."
      required
    />
    <ValidationError
      prefix="Phone Number"
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="max-w-md">
        <h1 className="text-3xl font-bold text-center mb-8">Complete los datos y seleccione su plan favorito</h1>
        <ContactWebForm />
      </div>
    </div>
  );
